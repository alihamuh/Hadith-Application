...
import alihamuh.islamic.book.sahihbukhari.DataBase_Helpers.CommonSQLiteUtilities;
    ...
    private ProgressDialog dialog;
        ...
        protected String doInBackground(String... f_url) {
            ...
            try {
                ...
                File dbFilePath = new File(appDataPath + "/databases/bukhari.zip");
                // Output stream
        ...
        protected void onPostExecute(String file_url) {
            ...
            unPackZipFiles zipFiles =new unPackZipFiles(appDataPath + "/databases/",appDataPath + "/databases/","/bukhari.zip");
            ...
            File databasePath = mContext.getApplicationContext().getDatabasePath("bukhari.db");
            File zipFile = mContext.getApplicationContext().getDatabasePath("bukhari.zip");
            long filesizeinMB= (zipFile.length())/(1024*1024);
            long filesizeinMBData= (databasePath.length())/(1024*1024);

            if (zipFile.exists() && filesizeinMB>=5) {
                ...
                if(databasePath.exists()&&filesizeinMBData>=25){
            ...
            Intent i = new Intent(mContext.getApplicationContext(), MainHadithContentpage.class);
